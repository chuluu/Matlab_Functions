...
%B = max_val;
if (A == 1) %Lab#2
    [poles,zeros,HF_2,Fd_2,hn_2,n_2] = MyDSP.show_filter_responses([1,0.1],[1,0,1],1000,500,20,1);
elseif (A == 2) %Lab#2
    [Ak,Bk,HF,Fd,hn,n] = MyDSP.show_filter_responses_pz([0,0],[-1i, 1i],1,1000,500,20,1); %[-0.5i,0.5i] 
...
elseif (A == 5) %Lab#2 Notch Filter
    [poles,zeros,HF_2,Fd_2,hn_2,n_2] = MyDSP.show_filter_responses([1],[0.5 0 0.5],1000,500,50,1);
